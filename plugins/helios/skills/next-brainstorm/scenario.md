...
packs), Scripting layer (depends on ADV-001 and configuration), and Theme packs (depends on
...
- One is recommended with two or three sentences of reasoning, and the rest are listed one line
  each.
